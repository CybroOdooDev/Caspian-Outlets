      ...
      <ul class="all-comment">
        ...
        <li>
          <div class="single-comment comment-section">
            <div class="left-area">
              <img
                src="<?php echo e($comment->user->photo != null ? asset('assets/images/users/'.$comment->user->photo) : asset('assets/images/'.$gs->user_image)); ?>"
                alt="">
              ...
              <div class="comment-footer">
                <div class="links">
                  <a href="javascript:;" class="comment-link reply mr-2"><i
                      class="fas fa-reply "></i><?php echo e($langg->lang107); ?></a>
                  <?php if(count($comment->replies) > 0): ?>
                  <a href="javascript:;" class="comment-link view-reply mr-2"><i
                      class="fas fa-eye "></i><?php echo e($langg->lang108); ?>

                    <?php echo e(count($comment->replies) == 1 ? $langg->lang109 : $langg->lang110); ?></a>
                  <?php endif; ?>
                  <?php if(Auth::guard('web')->user()->id == $comment->user->id): ?>
                  <a href="javascript:;" class="comment-link edit mr-2"><i
                      class="fas fa-edit "></i><?php echo e($langg->lang111); ?></a>
                  <a href="javascript:;" data-href="<?php echo e(route('product.comment.delete',$comment->id)); ?>"
                    class="comment-link comment-delete mr-2"><i class="fas fa-trash"></i><?php echo e($langg->lang112); ?></a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
          ...
          <div class="single-comment replay-review hidden">
            <div class="left-area">
              <img
                src="<?php echo e($reply->user->photo != null ? asset('assets/images/users/'.$reply->user->photo) : asset('assets/images/'.$gs->user_image)); ?>"
                alt="">
            ...
            <div class="right-area">
              ...
              <div class="comment-footer">
                <div class="links">
                  ...
                  <a href="javascript:;" class="comment-link edit mr-2"><i
                      class="fas fa-edit "></i><?php echo e($langg->lang111); ?></a>
                  <a href="javascript:;" data-href="<?php echo e(route('product.reply.delete',$reply->id)); ?>"
                    class="comment-link reply-delete mr-2"><i class="fas fa-trash"></i><?php echo e($langg->lang112); ?></a>
                  <?php endif; ?>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <h3 class="text-center"><a href="javascript:;" data-toggle="modal" data-target="#comment-log-reg"
              class="btn login-btn"><?php echo e($langg->lang101); ?></a> <?php echo e($langg->lang103); ?> </h3>
          <br>
        </div>
      </div>
        ...
        <li>
          <div class="single-comment">
            ...
            <div class="right-area">
              ...
              <div class="comment-footer">
                <div class="links">
                  <a href="javascript:;" class="comment-link"><i class="fas fa-eye"></i><?php echo e($langg->lang108); ?>
