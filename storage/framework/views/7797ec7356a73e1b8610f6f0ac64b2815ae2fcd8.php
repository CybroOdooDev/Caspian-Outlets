									...
									<div class="dropdownmenu-wrapper">
										...
										<ul class="dropdown-cart-products">
											...
											<li class="product cremove<?php echo e($product['item']['id'].$product['size']); ?>">
												<div class="product-details">
													<div class="content">
														<a href="<?php echo e(route('front.product',$product['item']['slug'])); ?>">
															<h4 class="product-title">
																<?php echo e(strlen($product['item']['name']) > 45 ? substr($product['item']['name'],0,45).'...' : $product['item']['name']); ?>
														...
														<span class="cart-product-info">
															<span class="cart-product-qty"
																id="cqt<?php echo e($product['item']['id'].$product['size']); ?>"><?php echo e($product['qty']); ?></span><span><?php echo e($product['item']['measure']); ?></span>
															x <span
																id="prct<?php echo e($product['item']['id'].$product['size']); ?>"><?php echo e(App\Models\Product::convertPrice($product['item']['price'])); ?></span>
														</span>
													</div>
												...
												<figure class="product-image-container">
													...
													<div class="cart-remove" data-class="cremove<?php echo e($product['item']['id'].$product['size']); ?>"
														data-href="<?php echo e(route('product.cart.remove',$product['item']['id'].$product['size'])); ?>"
