                        ...
                        <tr>
                            ...
                            <?php else: ?>
                                <tr>
                                    ...
                                    <th width="10%">:</th>
                <td><?php echo e($order->delivery_name == null ? $order->customer_name : $order->delivery_name); ?></td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong><?php echo e(__('Email')); ?>:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%"><?php echo e($order->delivery_email == null ? $order->customer_email : $order->delivery_email); ?></td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong><?php echo e(__('Phone')); ?>:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%"><?php echo e($order->delivery_phone == null ? $order->customer_phone : $order->delivery_phone); ?></td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong><?php echo e(__('Address')); ?>:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%"><?php echo e($order->delivery_address == null ? $order->customer_address : $order->delivery_address); ?></td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong><?php echo e(__('Country')); ?>:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%"><?php echo e($order->delivery_country == null ? $order->customer_country : $order->delivery_country); ?></td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong><?php echo e(__('City')); ?>:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%"><?php echo e($order->delivery_city == null ? $order->customer_city : $order->delivery_city); ?></td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong><?php echo e(__('Postal Code')); ?>:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%"><?php echo e($order->delivery_zip == null ? $order->customer_zip : $order->delivery_zip); ?></td>
                                </tr>
                                <?php endif; ?>
                                                </tbody>
                                            </table>
                            ...
                            <div class="row">
                                ...
                                <tr>
                                    ...
                                    <th width="10%"><?php echo e(__('Size')); ?></th>
                                    <th width="10%"><?php echo e(__('Color')); ?></th>
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" class="btn btn-info product-btn" id="license" style="padding: 5px 12px;"><i class="fa fa-eye"></i> <?php echo e(__('View License')); ?></a>
                                            ...
                                            <td><span style="width: 40px; height: 20px; display: block; background: <?php echo e($product['color']); ?>;"></span></td>
