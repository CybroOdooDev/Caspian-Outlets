							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="<?php echo e(route('admin-blog-index')); ?>"><?php echo e(__('Reviews')); ?></a>
											</li>
										</ul>
								</div>
							</div>
												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
									                        ...
									                        <th width="30%"><?php echo e(__('Sub Title')); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    ...
    <script type="text/javascript">
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="<?php echo e(route('admin-review-create')); ?>" id="add-data" data-toggle="modal" data-target="#modal1">'+
          '<i class="fas fa-plus"></i> <?php echo e(__('Add New Review')); ?>'+
          '</a>'+
          '</div>');
      });											
