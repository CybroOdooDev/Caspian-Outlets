              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="<?php echo e(route('admin-featuredbanner-index')); ?>">Featured Banners</a>
                      </li>
                    </ul>
                </div>
              </div>
...
<?php $__env->startSection('scripts'); ?>
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-featuredbanner-datatables')); ?>',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="<?php echo e(route('admin-featuredbanner-create')); ?>" id="add-data" data-toggle="modal" data-target="#modal1">'+
