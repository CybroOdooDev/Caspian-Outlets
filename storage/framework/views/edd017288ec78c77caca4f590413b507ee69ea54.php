...
<section class="checkout">
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<form id="step1-form" action="<?php echo e(route('cash.makePaymentMoMoANDCard')); ?>" method="POST" class="checkoutform">
									...
									<div class="content">
											...
											<div class="row">
												<div class="col-lg-6">
													<input type="text" id="personal-name" class="form-control"
														name="personal_name" placeholder="<?php echo e($langg->lang747); ?>"
														value="<?php echo e(Auth::check() ? Auth::user()->name : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
												</div>
												<div class="col-lg-6">
													<input type="email" id="personal-email" class="form-control"
														name="personal_email" placeholder="<?php echo e($langg->lang748); ?>"
														value="<?php echo e(Auth::check() ? Auth::user()->email : ''); ?>" <?php echo Auth::check() ? 'readonly' : ''; ?>>
												</div>
											</div>
											<?php if(!Auth::check()): ?>
											<div class="row">
											...
											<div class="row set-account-pass d-none">
												<div class="col-lg-6">
													<input type="password" name="personal_pass" id="personal-pass"
														class="form-control" placeholder="<?php echo e($langg->lang750); ?>">
												</div>
												<div class="col-lg-6">
													<input type="password" name="personal_confirm"
														id="personal-pass-confirm" class="form-control"
														placeholder="<?php echo e($langg->lang751); ?>">
												</div>
											</div>
											<?php endif; ?>
										</div>
										<div class="billing-address">
											...
											<div class="row">
												<div class="col-lg-6 <?php echo e($digital == 1 ? 'd-none' : ''); ?>">
													<select class="form-control" id="shipop" name="delivery"
														required="">
										...
										<div class="ship-diff-addres-area d-none">
											...
											<div class="row">
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text"
														name="delivery_name" id="deliveryFull_name"
														placeholder="<?php echo e($langg->lang152); ?>">
													<input type="hidden" name="delivery_email" value="">
												</div>
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text"
														name="delivery_phone" id="shipingPhone_number"
														placeholder="<?php echo e($langg->lang153); ?>">
												</div>
											</div>
											<div class="row">
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text"
														...
														placeholder="<?php echo e($langg->lang155); ?>">
												</div>

												<div class="col-lg-6">
													<select class="form-control ship_input" name="delivery_country">
														<?php echo $__env->make('includes.countries', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
													</select>
												</div>
											</div>
											<div class="row">
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text"
														name="delivery_city" id="delivery_city"
														placeholder="<?php echo e($langg->lang158); ?>">
												</div>
												<div class="col-lg-6">
													<input class="form-control ship_input" type="text"
														name="delivery_zip" id="deliveryPostal_code"
														placeholder="<?php echo e($langg->lang159); ?>">
												</div>
											...
											<div class="row">
												<div class="col-lg-12">
													<input type="text" id="Order_Note" class="form-control"
														name="order_notes"
														placeholder="<?php echo e($langg->lang217); ?> (<?php echo e($langg->lang218); ?>)">
												</div>
											</div>
										</div>
										<div class="row">
											...
											<div class="col-lg-12 mt-3">
												<div class="bottom-area">
													<a href="javascript:;" id="step1-btn"
														class="mybtn1 mr-3"><?php echo e($langg->lang757); ?></a>
													<a href="javascript:;" id="step3-btn"
														class="mybtn1"><?php echo e($langg->lang753); ?></a>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="content-box">
									<div class="content">
										...
										<div class="billing-info-area <?php echo e($digital == 1 ? 'd-none' : ''); ?>">
											...
											<ul class="info-list">
												<li>
													<p id="delivery_user"></p>
												</li>
												<li>
													<p id="delivery_location"></p>
												</li>
												<li>
													<p id="delivery_phone"></p>
												</li>
												<li>
													<p id="delivery_email"></p>
												</li>
											</ul>
										</div>
										<br>
												...
												<div class="col-lg-12">
													<div class="nav flex-column" role="tablist"
														...
														<a class="nav-link payment active" data-show="no"
															data-form="<?php echo e(route('paypal.submit')); ?>"
															data-href="<?php echo e(route('front.load.payment',['slug1' => 'paypal','slug2' => 0])); ?>"
														...
														<a class="nav-link payment" data-show="yes"
															data-form="<?php echo e(route('stripe.submit')); ?>"
															data-href="<?php echo e(route('front.load.payment',['slug1' => 'stripe','slug2' => 0])); ?>"
														...
														<!--	data-form="<?php echo e(route('cash.submit')); ?>"-->
														<!--	data-href="<?php echo e(route('front.load.payment',['slug1' => 'cod','slug2' => 0])); ?>"-->
  ...
  <input class="form-check-input" type="radio" name="paymentMethod" id="exampleRadios1" value="8" checked>
  <label class="form-check-label" for="exampleRadios1">
    Cash On delivery
														...
														<div class="col-lg-12">
												    <div class="form-check">
  <input class="form-check-input" type="radio" name="paymentMethod" id="exampleRadios1" value="9" checked>
  <label class="form-check-label" for="exampleRadios1">
    Card / MoMo Payment
  </label>
</div>
														...
														<a class="nav-link payment" data-show="no"
															data-form="<?php echo e(route('instamojo.submit')); ?>"
															data-href="<?php echo e(route('front.load.payment',['slug1' => 'instamojo','slug2' => 0])); ?>"
														...
														<a class="nav-link payment" data-show="no"
															data-form="<?php echo e(route('paystack.submit')); ?>"
															data-href="<?php echo e(route('front.load.payment',['slug1' => 'paystack','slug2' => 0])); ?>"
														...
														<a class="nav-link payment" data-show="yes"
															data-form="<?php echo e(route('gateway.submit')); ?>"
															data-href="<?php echo e(route('front.load.payment',['slug1' => 'other','slug2' => $gt->id])); ?>"
												...
												<div class="col-lg-12">
													<div class="pay-area d-none">
														<div class="tab-content" id="v-pills-tabContent">
															...
															<div class="tab-pane fade" id="v-pills-tab<?php echo e($gs->id); ?>"
																role="tabpanel"
																aria-labelledby="v-pills-tab<?php echo e($gs->id); ?>-tab">
											...
											<div class="col-lg-12 mt-3">
												<div class="bottom-area">
													...
													<button type="submit" id="final-btn"
														class="mybtn1"><?php echo e($langg->lang753); ?></button>
												</div>
					...
					<input type="hidden" id="delivery-cost" name="delivery_cost" value="0">
					...
					<input type="hidden" name="vendor_delivery_id" value="<?php echo e($vendor_delivery_id); ?>">
					...
					<div class="order-box">
						...
						<ul class="order-list">
							...
							<li class="discount-bar">
								<p>
									<?php echo e($langg->lang145); ?> <span
										class="dpercent"><?php echo e(Session::get('coupon_percentage') == 0 ? '' : '('.Session::get('coupon_percentage').')'); ?></span>
								</p>
								<P>
						...
						<div class="cupon-box">
							...
							<form id="check-coupon-form" class="coupon">
								<input type="text" placeholder="<?php echo e($langg->lang133); ?>" id="code" required=""
									autocomplete="off">
						...
						<div class="packeging-area">
							...
							<?php $__currentLoopData = $delivery_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

							<div class="radio-design">
								<input type="radio" class="delivery" id="free-shepping<?php echo e($data->id); ?>" name="delivery"
									value="<?php echo e(round($data->price * $curr->value,2)); ?>"
						...
						<div class="packeging-area">
							...
							<div class="radio-design">
								<input type="radio" class="packing" id="free-package<?php echo e($data->id); ?>" name="packeging"
									value="<?php echo e(round($data->price * $curr->value,2)); ?>"
									<?php echo e(($loop->first) ? 'checked' : ''); ?>>
								<span class="checkmark"></span>
						...
						<a href="<?php echo e(route('front.checkout')); ?>" class="order-btn mt-4">
							...
							<div class="login-form signup-form">
								...
								<form id="registerform" action="<?php echo e(route('user-register-submit')); ?>" method="POST">
									...
									<ul class="captcha-area">
										<li>
											<p><img class="codeimg1" src="<?php echo e(asset("\assets\images\capcha_code.png")); ?>"
...
<script type="text/javascript">
	...
	// Delivery Address Checking Ends
...
<script type="text/javascript">
	...
	$('#step3-btn').on('click', function () {
		...
		var delivery_user = !$('input[name="delivery_name"]').val() ? $('input[name="name"]').val() : $(
			'input[name="delivery_name"]').val();
		var delivery_location = !$('input[name="delivery_address"]').val() ? $('input[name="address"]').val() : $(
			'input[name="delivery_address"]').val();
		var delivery_phone = !$('input[name="delivery_phone"]').val() ? $('input[name="phone"]').val() : $(
			'input[name="delivery_phone"]').val();
		var delivery_email = !$('input[name="delivery_email"]').val() ? $('input[name="email"]').val() : $(
			'input[name="delivery_email"]').val();

		$('#delivery_user').html('<i class="fas fa-user"></i>' + delivery_user);
		$('#delivery_location').html('<i class="fas fas fa-map-marker-alt"></i>' + delivery_location);
		$('#delivery_phone').html('<i class="fas fa-phone"></i>' + delivery_phone);
		$('#delivery_email').html('<i class="fas fa-envelope"></i>' + delivery_email);
