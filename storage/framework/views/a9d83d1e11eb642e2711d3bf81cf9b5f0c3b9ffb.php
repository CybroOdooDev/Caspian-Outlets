				...
				<i class="icofont-upload-alt"></i> <?php echo e(__('Upload Image Here')); ?>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																<input class="checkclick1" name="delivery_time_check" type="checkbox" id="check1" value="1">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="<?php echo e(__('Estimated Delivery Time')); ?>" name="ship">
													</div>
												</div>
