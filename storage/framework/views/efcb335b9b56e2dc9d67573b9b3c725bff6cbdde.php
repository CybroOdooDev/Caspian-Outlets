...
<?php $__env->startSection('content'); ?>
                        ...
                        <?php echo $__env->make('includes.admin.form-both', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
											...
											<div id="f-file" <?php echo filter_var($data->photo,FILTER_VALIDATE_URL) ? 'style="display:none"' : ''; ?>>
							                     <div class="row">
							                        <div class="col-lg-4">
							                          <div class="left-area">
		...
		<div class="span4 cropme text-center" id="landscape" style="width: 400px; height: 400px; border: 1px dashed black;">
			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> <?php echo e(__("Upload Image Here")); ?>
											  ...
											  <div id="f-link" <?php echo !filter_var($data->photo,FILTER_VALIDATE_URL) ? 'style="display:none"' : ''; ?>>
												  <div class="row">
													  <div class="col-lg-4">
														  <div class="left-area">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																<input class="checkclick1" name="delivery_time_check" type="checkbox" id="check1" value="1" <?php echo e($data->ship != null ? "checked":""); ?>>
																<label for="check1"><?php echo e(__("Allow Estimated Delivery Time")); ?></label>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading"><?php echo e(__("Product Estimated Delivery Time")); ?>* </h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="Estimated Delivery Time" name="ship" value="<?php echo e($data->ship == null ? "" : $data->ship); ?>">
													</div>
												</div>
																	 ...
																	 <?php $__currentLoopData = $data->size; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																		...
																		<div  class="row">
																				...
																				<div class="col-md-4 col-sm-6">
																					...
																					<input type="number" name="size_price[]" class="input-field" placeholder="Size Price" min="0" value="<?php echo e($data->size_price[$key]); ?>">
																				</div>
																			</div>
																		</div>
																	 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
