            ...
            <div class="col-lg-6">
                <div class="invoice__orderDetails">
                    ...
                    <span><strong>{{ __('Customer Name') }}</strong>:
                        {{ $order->delivery_name == null ? $order->customer_name : $order->delivery_name}}</span><br>
                    <span><strong>{{ __('Address') }}</strong>:
                        {{ $order->delivery_address == null ? $order->customer_address : $order->delivery_address }}</span><br>
                    <span><strong>{{ __('City') }}</strong>:
                        {{ $order->delivery_city == null ? $order->customer_city : $order->delivery_city }}</span><br>
                    <span><strong>{{ __('Country') }}</strong>:
                        {{ $order->delivery_country == null ? $order->customer_country : $order->delivery_country }}</span>
                </div>
            </div>
            @endif
