                    ...
                    <div class="order-details">
                        ...
                        <div class="view-order-page">
                            ...
                            <div class="delivery-add-area">
                                <div class="row">
                                    <div class="col-md-6">
                                        @if($order->delivery == "shipto")
                                        <h5>{{ $langg->lang302 }}</h5>
                                        <address>
                                            {{ $langg->lang288 }}
                                            {{$order->delivery_name == null ? $order->customer_name : $order->delivery_name}}<br>
                                            {{ $langg->lang289 }}
                                            {{$order->delivery_email == null ? $order->customer_email : $order->delivery_email}}<br>
                                            {{ $langg->lang290 }}
                                            {{$order->delivery_phone == null ? $order->customer_phone : $order->delivery_phone}}<br>
                                            {{ $langg->lang291 }}
                                            {{$order->delivery_address == null ? $order->customer_address : $order->delivery_address}}<br>
                                            {{$order->delivery_city == null ? $order->customer_city : $order->delivery_city}}-{{$order->delivery_zip == null ? $order->customer_zip : $order->delivery_zip}}
                                        </address>
                                        @else
                                        <h5>{{ $langg->lang303 }}</h5>
                                        <address>
