...
Route::get('/mailSend', 'Front\PaymentController@sending');

Route::get('/emailsSend', 'Front\PaymentController@email')->name('email');
...
Route::get('/delivery/datatables', 'Admin\DeliveryController@datatables')->name('admin-delivery-datatables');
Route::get('/delivery', 'Admin\DeliveryController@index')->name('admin-delivery-index');
Route::get('/delivery/create', 'Admin\DeliveryController@create')->name('admin-delivery-create');
Route::post('/delivery/create', 'Admin\DeliveryController@store')->name('admin-delivery-store');
Route::get('/delivery/edit/{id}', 'Admin\DeliveryController@edit')->name('admin-delivery-edit');
Route::post('/delivery/edit/{id}', 'Admin\DeliveryController@update')->name('admin-delivery-update');
Route::get('/delivery/delete/{id}', 'Admin\DeliveryController@destroy')->name('admin-delivery-delete');
...
// ************************************ FRONT SECTION **********************************************
  ...
  Route::get('/orchardCallback/','Front\CheckoutController@orchardCallback')->name('front.orchardCallback');
    Route::get('/orchardCallback2/','Front\CheckoutController@orchardCallback2')->name('front.orchardCallback2');
  ...
  Route::post('/', 'Front\PaymentController@makePayment')->name('payment.makePayment');
  ...
  Route::post('/makePaymentMoMoANDCard', 'Front\CheckoutController@makePaymentMoMoANDCard')->name('cash.makePaymentMoMoANDCard');
