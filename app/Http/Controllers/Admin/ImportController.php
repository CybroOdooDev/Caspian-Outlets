...
class ImportController extends Controller
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('action', function(Product $data) {
                                return '<div class="action-list"><a href="' . route('admin-import-edit',$data->id) . '"> <i class="fas fa-edit"></i>Edit</a><a href="javascript" class="set-gallery" data-toggle="modal" data-target="#setgallery"><input type="hidden" value="'.$data->id.'"><i class="fas fa-eye"></i> View Gallery</a><a data-href="' . route('admin-prod-feature',$data->id) . '" class="feature" data-toggle="modal" data-target="#modal2"> <i class="fas fa-star"></i>Highlight</a><a href="javascript:;" data-href="' . route('admin-prod-delete',$data->id) . '" data-toggle="modal" data-target="#confirm-delete" class="delete"><i class="fas fa-trash-alt"></i></a></div>';
                            }) 
    ...
    public function store(Request $request)
    {
        ...
        //--- Logic Section        
            ...
            // Check Delivery Time
            if ($request->delivery_time_check == ""){
                $input['ship'] = null;
            } 
        ...
        if (!empty($request->meta_tag)) 
         {
            ...
            // Set SLug
                ...
                $img->save(public_path().'\assets\images\\thumbnails/'.$thumbnail);
    ...
    public function update(Request $request, $id)
    {
        ...
        //-- Logic Section Ends
                ...
                if($data->photo != null)
                {
                    if (file_exists(public_path().'\assets\images\\thumbnails/'.$data->thumbnail)) {
                        unlink(public_path().'\assets\images\\thumbnails/'.$data->thumbnail);
                    }
                } 
