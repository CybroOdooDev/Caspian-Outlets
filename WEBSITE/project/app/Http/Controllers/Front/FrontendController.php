...
// -------------------------------- HOME PAGE SECTION ----------------------------------------
	...
	public function index(Request $request)
	{
        ...
        $discount_products =  Product::where('is_discount','=',1)->where('status','=',1)->inRandomOrder()->take(8)->get();
        $feature_products =  Product::where('featured','=',1)->where('status','=',1)->inRandomOrder()->take(8)->get();
        $best_products = Product::where('best','=',1)->where('status','=',1)->inRandomOrder()->take(8)->get(); 
        $top_products = Product::where('top','=',1)->where('status','=',1)->inRandomOrder()->take(8)->get();;
        $big_products = Product::where('big','=',1)->where('status','=',1)->inRandomOrder()->take(8)->get();;
        $hot_products =  Product::where('hot','=',1)->where('status','=',1)->inRandomOrder()->take(9)->get();
        $latest_products =  Product::where('latest','=',1)->where('status','=',1)->inRandomOrder()->take(9)->get();
        $trending_products =  Product::where('trending','=',1)->where('status','=',1)->inRandomOrder()->take(9)->get();
        $sale_products =  Product::where('sale','=',1)->where('status','=',1)->inRandomOrder()->take(9)->get();
...
// CURRENCY SECTION ENDS
    ...
    public function autosearch($slug)
    {
        if(strlen($slug) > 1){
            $search = ' '.$slug;
            $prods = Product::where('name', 'like', '%' . $search . '%')->orWhere('name', 'like', $slug . '%')->where('status','=',1)->inRandomOrder()->take(10)->get();
...
// -------------------------------- Faq SECTION ----------------------------------------
	public function Faq()
	{
		...
		return view('front.faq',compact('faqs'))->with('faqs', $Faqs);;
	}
// -------------------------------- Faq SECTION ENDS----------------------------------------
