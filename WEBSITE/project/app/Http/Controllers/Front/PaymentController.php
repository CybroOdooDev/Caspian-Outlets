     ...
     /*   if($gs->is_smtp == 1)
        {
            $data = [
             ...
             $data1 = [
                'to' => 'dipti@pearlorganisation.com',
                'subject' => "New Order Recieved!!",
                'body' => "Hello Admin!<br>Your store has received a new order.<br>Order Number is ".$item_number.".Please login to your panel to check. <br>Thank you.",
            ];
...
*/
  ...
  $gs = Generalsetting::findOrFail(1);
       $to1 = 'dipti@pearlorganisation.com';
           $subject = "New Order Recieved!!";
           $msg = "Hello Admin!\nYour store has recieved a new order.\nOrder Number is 11111.Please login to your panel to check. \nThank you.";
            $headers = "From: ".$gs->from_name."<".$gs->from_email.">";
       $res=    mail($to1,$subject,$msg,$headers);
