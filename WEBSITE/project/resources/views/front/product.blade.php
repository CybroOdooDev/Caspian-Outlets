            ...
            <div id="product-details-tab">
              <div class="top-menu-area">
                <ul class="tab-menu">
                  ...
                  <li><a href="#tabs-3">{{ $langg->lang94 }}(<span id="rating-count">{{ count($productt->ratings) }}</span>)</a></li>
                  @if($gs->is_comment == 1)
