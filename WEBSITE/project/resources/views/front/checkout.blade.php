	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-8">
				...
				<form id="step1-form" action="{{route('cash.makePaymentMoMoANDCard')}}" method="POST" class="checkoutform">
							...
							<div class="tab-pane fade" id="pills-step2" role="tabpanel"
								...
								<div class="content-box">
									<div class="content">
										...
										<table class="row" style="overflow-y: scroll; margin-top: 3%;">
										    <tr>
										        <td>
												<div class="bottom-area">
...
<div class="form-check">
  <input class="form-check-input" type="radio" name="paymentMethod" id="exampleRadios1" value="8">
  <label class="form-check-label" for="exampleRadios1">
    Cash On delivery
  </label>
</div>
					...
					<input type="hidden" name="vendor_delivery_id" value="{{ @$vendor_delivery_id }}">
					...
					<div class="order-box">
						...
						<div class="packeging-area">
							...
							<div class="radio-design">
								<input type="radio" class="delivery" id="free-shepping{{ $data->id }}" name="delivery"
