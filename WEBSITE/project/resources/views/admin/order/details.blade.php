                        ...
                        <tr>
                            ...
                            @else
                                <tr>
                                    ...
                                    <th width="10%">:</th>
                <td>{{$order->delivery_name == null ? $order->customer_name : $order->delivery_name}}</td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong>{{ __('Email') }}:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%">{{$order->delivery_email == null ? $order->customer_email : $order->delivery_email}}</td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong>{{ __('Phone') }}:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%">{{$order->delivery_phone == null ? $order->customer_phone : $order->delivery_phone}}</td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong>{{ __('Address') }}:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%">{{$order->delivery_address == null ? $order->customer_address : $order->delivery_address}}</td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong>{{ __('Country') }}:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%">{{$order->delivery_country == null ? $order->customer_country : $order->delivery_country}}</td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong>{{ __('City') }}:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%">{{$order->delivery_city == null ? $order->customer_city : $order->delivery_city}}</td>
                                </tr>
                                <tr>
                                    <th width="45%"><strong>{{ __('Postal Code') }}:</strong></th>
                                    <th width="10%">:</th>
                <td width="45%">{{$order->delivery_zip == null ? $order->customer_zip : $order->delivery_zip}}</td>
                                </tr>
                                @endif
                                                </tbody>
                                            </table>
