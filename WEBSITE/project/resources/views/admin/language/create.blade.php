                  ...
                  <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang86" placeholder="Estimated Delivery Time"
                            required="" value="Estimated Delivery Time">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang143" placeholder="Delivery Cost" required=""
                            value="Delivery Cost">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang148" placeholder="Delivery Details"
                            required="" value="Delivery Details">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang149" placeholder="Deliver To Address"
                            required="" value="Deliver To Address">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang752" placeholder="Delivery Details"
                            required="" value="Delivery Details">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang758" placeholder="Delivery Info" required=""
                            value="Delivery Info">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang765" placeholder="Delivery Method"
                            required="" value="Delivery Method">
                        </div>
                      </div>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang302" placeholder="Delivery Address"
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang305" placeholder="Delivery Method"
                            required="" value="Delivery Method">
                        </div>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-7">
                          <input type="text" class="input-field" name="lang306" placeholder="Deliver To Address"
                            required="" value="Deliver To Address">
                        </div>
                      </div>
