                     ...
                     <hr>
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang86" placeholder="Estimated Delivery Time" required="" value="{{ $lang->lang86 }}">
                          </div>
                        </div>
                      ...
                      <hr>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Delivery Cost *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang143" placeholder="Delivery Cost" required="" value="{{ $lang->lang143 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang148" placeholder="Delivery Details" required="" value="{{ $lang->lang148 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading">Deliver To Address *</h4>
                                <p class="sub-heading">(In Any Language)</p>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang149" placeholder="Deliver To Address" required="" value="{{ $lang->lang149 }}">
                          </div>
                        </div>
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang167" placeholder="Transaction ID#" required="" value="{{ $lang->lang167 }}">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-lg-7">
                                                      <input type="text" class="input-field" name="lang752" placeholder="Delivery Details" required="" value="{{ $lang->lang752 }}">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="row">
                                                    <div class="col-lg-4">
                                                      <div class="left-area">
                                                          <h4 class="heading">Delivery Info *</h4>
                                                          <p class="sub-heading">(In Any Language)</p>
                                                      </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                      <input type="text" class="input-field" name="lang758" placeholder="Delivery Info" required="" value="{{ $lang->lang758 }}">
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="row">
                                                    <div class="col-lg-4">
                                                      <div class="left-area">
                                                          <h4 class="heading">Delivery Method *</h4>
                                                          <p class="sub-heading">(In Any Language)</p>
                                                      </div>
                                                    </div>
                                                    <div class="col-lg-7">
                                                      <input type="text" class="input-field" name="lang765" placeholder="Delivery Method" required="" value="{{ $lang->lang765 }}">
                                                    </div>
                                                  </div>
 ...
 {{-- USER PANEL STARTS --}}
                      ...
                      <hr>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang302" placeholder="Delivery Address" required="" value="{{ $lang->lang302 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang305" placeholder="Delivery Method" required="" value="{{ $lang->lang305 }}">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="lang306" placeholder="Deliver To Address" required="" value="{{ $lang->lang306 }}">
                          </div>
                        </div>
