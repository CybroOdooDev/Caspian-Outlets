...
{
    "name" : "Odoo User Direct Login to POS Screen App",
    "version" : "14.0.0.0",
    "category" : "Point of Sale",
    "depends" : ['base','sale_management','point_of_sale','website'],
    "author": "BrowseInfo",
    'summary': 'This apps allows you to Redirect on POS screen without going to backend POS Direct Login Odoo POS User Login POS session Direct Login pos screen login direct login point of sales direct pos login pos sign in pos signin direct pos direct sign in pos access',
    "description": """
...
odoo pos screen directly point of sales cashier login point of sales direct login point of sales user login
    ...
    'qweb': [],
    'depends': ['hr_attendance', 'point_of_sale'],
    "auto_install": False,
    "installable": True,
