				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																<input class="checkclick1" name="delivery_time_check" type="checkbox" id="check1" value="1" {{$data->ship != null ? "checked":""}}>
																<label for="check1">{{ __('Allow Estimated Delivery Time') }}</label>
															</li>
														</ul>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Product Estimated Delivery Time') }}* </h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ __('Estimated Delivery Time') }}" name="ship" value="{{ $data->ship == null ? "" : $data->ship }}">
													</div>
												</div>
